...
public class BookAFlightTest extends BaseTest {
    ...
    public void setup(){
        ...
        confirmationPage = PageFactory.initElements(driver, ConfirmPage.class);
    ...
    public Object[][] bookFlightsData(){
        ...
        for(int i = 0; i< bookFlights.size(); i++){
            for(String[] bookFlight : bookFlights){
                rawData[i++][0] = new BookingDetails(bookFlight);
            }
        }
        return rawData;
    }
    ...
    public void searchForFlights(BookingDetails data){
    ...
    public void chooseLowestPricedAirline(BookingDetails data){
    ...
    public void purchaseFlightTicket(BookingDetails data){
